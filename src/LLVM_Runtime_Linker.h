...
/** Create an llvm module containing the support code for hwacha device. */
std::unique_ptr<llvm::Module> get_initial_module_for_hwacha_device(Target, llvm::LLVMContext *c);
