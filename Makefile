...
HWACHA_CXX_FLAGS=$(if $(WITH_HWACHA), -DWITH_HWACHA=1, )
HWACHA_LLVM_CONFIG_LIB=$(if $(WITH_HWACHA), , )
...
RUNTIME_EXPORTED_INCLUDES = $(INCLUDE_DIR)/HalideRuntime.h \
                            ...
                            $(INCLUDE_DIR)/HalideRuntimeHwacha.h \
